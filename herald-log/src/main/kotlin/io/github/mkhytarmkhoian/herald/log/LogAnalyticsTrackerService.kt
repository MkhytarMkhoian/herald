...
public class LogAnalyticsTrackerService(
    private val eventTrackerFactory: LogEventTrackerFactory,
    private val propertySetterFactory: LogPropertySetterFactory,
) : EventTrackerService, PropertyTrackerService {

    // Unclaimed events and properties are ignored. End the chain with RequireMappedLogEventTrackerFactory
